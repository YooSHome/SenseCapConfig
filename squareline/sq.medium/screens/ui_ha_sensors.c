...
lv_obj_set_height( ui_sensor1_btn, 105);
...
lv_obj_set_x( ui_sensor1_data, -50 );
lv_obj_set_y( ui_sensor1_data, -2 );
lv_obj_set_align( ui_sensor1_data, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_y( ui_sensor1_unit, -2 );
lv_obj_set_align( ui_sensor1_unit, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_style_text_font(ui_sensor1_unit, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_sensor2_btn = lv_btn_create(ui_ha_sensors);
lv_obj_set_width( ui_sensor2_btn, 214);
lv_obj_set_height( ui_sensor2_btn, 105);
...
lv_obj_set_x( ui_sensor2_data, -50 );
lv_obj_set_y( ui_sensor2_data, -2 );
lv_obj_set_align( ui_sensor2_data, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_y( ui_sensor2_unit, -2 );
lv_obj_set_align( ui_sensor2_unit, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_style_text_font(ui_sensor2_unit, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_sensor3_btn = lv_btn_create(ui_ha_sensors);
lv_obj_set_width( ui_sensor3_btn, 214);
lv_obj_set_height( ui_sensor3_btn, 105);
lv_obj_set_x( ui_sensor3_btn, 22 );
lv_obj_set_y( ui_sensor3_btn, 209 );
...
lv_obj_set_x( ui_sensor3_data, -50 );
lv_obj_set_y( ui_sensor3_data, -2 );
lv_obj_set_align( ui_sensor3_data, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_y( ui_sensor3_unit, -2 );
lv_obj_set_align( ui_sensor3_unit, LV_ALIGN_RIGHT_MID );
lv_label_set_text(ui_sensor3_unit,"pp");
...
lv_obj_set_height( ui_sensor4_btn, 105);
lv_obj_set_x( ui_sensor4_btn, 22 );
lv_obj_set_y( ui_sensor4_btn, 322 );
...
lv_obj_set_x( ui_sensor4_data, -50 );
lv_obj_set_y( ui_sensor4_data, -2 );
lv_obj_set_align( ui_sensor4_data, LV_ALIGN_RIGHT_MID );
...
lv_obj_set_y( ui_sensor4_unit, -2 );
lv_obj_set_align( ui_sensor4_unit, LV_ALIGN_RIGHT_MID );
lv_label_set_long_mode(ui_sensor4_unit,LV_LABEL_LONG_DOT);
lv_label_set_text(ui_sensor4_unit,"pp");
...
lv_obj_set_style_text_font(ui_sensor4_unit, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
